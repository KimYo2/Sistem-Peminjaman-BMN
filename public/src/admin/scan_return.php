...
<body class="dark:bg-slate-900 min-h-screen transition-colors duration-200">
    ...
    <main class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div
            ...
            <div class="flex">
                ...
                <div>
                    <h4 class="font-semibold text-green-900 dark:text-green-200 mb-1 transition-colors">Cara
                        Menggunakan:</h4>
                    <ol
    ...
    <script>
        ...
        async function handleQRScanReturn(decodedText, decodedResult) {
            ...
            const result = await apiCall('kembalikan_barang.php', 'POST', { nomor_bmn: decodedText });
                    ...
                    <div class="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-6 transition-colors">
                        <div class="flex items-center mb-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-green-700 dark:text-green-300">Barang ${decodedText} telah dikembalikan</p>
                            </div>
                        </div>
